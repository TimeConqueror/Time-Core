...
class BlockRegisterContext<B : Block>(
    val register: BlockRegister,
    private val chainConfigurator: ChainConfigurator<B>? = null
) {
...
class BlockGroupContext<B : Block>(
    private val register: BlockRegister,
    private val chainConfigurator: ChainConfigurator<B>
) {
