...
//
//        protected StructureRegisterChain(RegistryObject<S> regObj, T featureConfig) {
//            super(regObj);
//
...
//
//        public StructureInfo(RegistryObject<S> registryObject, Function<S, ConfiguredStructureFeature<T, ? extends StructureFeature<T>>> structureFeatureFactory) {
//            this.registryObject = registryObject;
