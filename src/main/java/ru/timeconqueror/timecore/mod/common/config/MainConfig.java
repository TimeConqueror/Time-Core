...
public class MainConfig extends Config {
    ...
    public QuickConfigValue<Boolean> devFeaturesEnabled;
    public QuickConfigValue<Boolean> suppressExperimentalWarning;
    ...
    public void setup(ImprovedConfigBuilder builder) {
        devFeaturesEnabled = builder.optimizedVal(
        ...
        suppressExperimentalWarning = builder.optimizedVal(
