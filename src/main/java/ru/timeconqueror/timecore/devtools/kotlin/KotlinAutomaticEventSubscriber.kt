package ru.timeconqueror.timecore.devtools.kotlin
...
object KotlinAutomaticEventSubscriber {
    ...
    fun inject(mod: ModContainer, scanData: ModFileScanData?, loader: ClassLoader?) {
        ...
        LOGGER.debug(Logging.LOADING, "Attempting to inject @EventBusSubscriber Kotlin classes into the eventbus for {}", mod.modId)
