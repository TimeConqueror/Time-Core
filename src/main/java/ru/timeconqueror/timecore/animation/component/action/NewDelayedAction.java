package ru.timeconqueror.timecore.animation.component.action;

import ru.timeconqueror.timecore.animation.AnimationStarter;
import ru.timeconqueror.timecore.api.animation.Animation;
import ru.timeconqueror.timecore.api.animation.action.IDelayedAction;

//TODO rename to DelayedAction in 1.18+
public class NewDelayedAction<T, EXTRA_DATA> implements IDelayedAction<T, EXTRA_DATA> {
    ...
    public NewDelayedAction(String id, String layer, AnimationStarter starter, Handler<? super T, ? super EXTRA_DATA> handler, boolean repeatedOnLoop) {
        this.id = id;
