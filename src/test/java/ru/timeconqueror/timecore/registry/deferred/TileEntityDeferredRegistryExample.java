...
public class TileEntityDeferredRegistryExample {
    ...
    public static RegistryObject<TileEntityType<DummyTileEntity>> TEST_TE_TYPE = REGISTER.regTileEntityType("test_tile", DummyTileEntity::new, () -> new Block[]{BlockRegistryExample.TEST_BLOCK_WITH_TILE})
