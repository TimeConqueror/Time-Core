...
public class EntityCommonRegistryExample {
    public static final EntityType<EntityZombie> ZOMBIE_TYPE = EntityType.Builder.create(EntityZombie::new, EntityClassification.CREATURE)
            .setTrackingRange(80)
            .setShouldReceiveVelocityUpdates(true)
            .size(1, 2)
            .build(TimeCore.MODID + ":zombie");
    public static final EntityType<EntityFloro> FLORO = EntityType.Builder.create(EntityFloro::new, EntityClassification.MONSTER)
            .setTrackingRange(80)
            .setShouldReceiveVelocityUpdates(true)
            .size(1, 2)
...
//        FLORO_HIDING = TimeClientLoader.loadAnimations(new ResourceLocation(TimeCore.MODID, "animations/floro.hiding.json")).get(0);
        HIT_ANIMATION = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/zombie_hit.json"));
        SCALING_ANIMATION = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/scaling.json"));
        OFFSETTING_ANIMATION = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/offsetting.json"));
        FLORO_SHOOT = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/floro.shoot.json"));
        FLORO_SHOWING = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/floro.showing.json"));
        FLORO_WALK = AnimationAPI.loadAndRegisterAnimation(new ResourceLocation(TimeCore.MODID, "animations/floro.walk.json"));
    }
    ...
    public static void registerRenders(FMLClientSetupEvent event) {
        ...
        RenderingRegistry.registerEntityRenderingHandler(ZOMBIE_TYPE, RenderZombie::new);
