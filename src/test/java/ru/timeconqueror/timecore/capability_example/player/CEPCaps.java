...
public class CEPCaps {
    ...
    public static void onCommonSetup(FMLCommonSetupEvent event) {
        event.enqueueWork(() -> TimeCore.INSTANCE.getCapabilityManager().attachStaticCoffeeCapability(CapabilityOwner.ENTITY, MY_CAPABILITY, entity -> entity instanceof Player, entity -> new MyPlayerCapability(((Player) entity))));
    }
}
